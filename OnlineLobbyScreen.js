...
export default function OnlineLobby({ onExit }) {
  ...
  return <SafeAreaView style={styles.page}><View style={styles.wrap}>
    ...
    <Text style={styles.title}>ONLINE-LOBBY</Text><Text style={styles.subtitle}>Große Klappe kennt keine Entfernung.</Text>
...
const styles = StyleSheet.create({page:{flex:1,backgroundColor:'#080808'},wrap:{flex:1,justifyContent:'center',padding:26},back:{color:'#999',fontWeight:'800',marginBottom:28},title:{color:'#fff',fontSize:39,fontWeight:'900',textAlign:'center'},subtitle:{color:RED,textAlign:'center',fontWeight:'800',marginBottom:28},notice:{backgroundColor:'#17110e',borderLeftColor:'#f1bd36',borderLeftWidth:4,padding:13,marginBottom:18},noticeTitle:{color:'#f1bd36',fontWeight:'900'},noticeText:{color:'#aaa',marginTop:4,lineHeight:19},label:{color:'#777',fontSize:11,letterSpacing:2,marginBottom:7},input:{backgroundColor:'#161616',borderColor:'#333',borderWidth:1,color:'#fff',padding:15,borderRadius:5,fontSize:17},codeInput:{textAlign:'center',fontSize:25,fontWeight:'900',letterSpacing:6},primary:{backgroundColor:RED,padding:18,borderRadius:5,marginTop:12},outline:{borderColor:'#555',borderWidth:1,padding:17,borderRadius:5,marginTop:12},disabled:{opacity:.35},buttonText:{color:'#fff',fontWeight:'900',textAlign:'center',letterSpacing:1},or:{color:'#666',textAlign:'center',marginVertical:19,fontSize:11,letterSpacing:2},error:{color:'#ff7378',textAlign:'center',marginTop:14},small:{color:'#777',textAlign:'center',letterSpacing:2},code:{color:'#fff',textAlign:'center',fontSize:52,fontWeight:'900',letterSpacing:8,marginVertical:8},hint:{color:'#888',textAlign:'center'},playerBox:{backgroundColor:'#141414',padding:18,marginVertical:25},player:{color:'#fff',fontWeight:'900',paddingVertical:8},waiting:{color:'#555',paddingVertical:8}});
